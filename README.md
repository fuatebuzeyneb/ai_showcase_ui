...
This project focuses purely on **UI/UX**, animation choreography, and interaction design —  
**no backend or AI logic involved**.

---

## ✨ Features

- Multi-stage AI generation flow  
  *(Idle → Generating → Results → Reveal)*
...
[Watch the demo video.  ](https://www.linkedin.com/posts/fuat-ebuzeyneb-b7b29b282_flutter-uiux-mobiledevelopment-activity-7409478730932244480-5lRq?utm_source=share&utm_medium=member_desktop&rcm=ACoAAES94c8BVLgnOgOL9RVspCR5nzXgCZ9r-bw)
...
- Lottie
- Custom animations  
  *(AnimationController, Transform, CustomPainter)*
- Gesture handling
